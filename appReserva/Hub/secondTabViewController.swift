...
class secondTabViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let imageNames = Array(1...7).map {"labIoT\($0)"}
...
//        collectionView.backgroundColor = UIColor.init(red: 204/255, green: 0/255, blue: 204/255, alpha: 0.1)
        collectionView.register(ImageCollectionViewCell2.self, forCellWithReuseIdentifier: ImageCollectionViewCell2.identifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ImageCollectionViewCell2.identifier, for: indexPath) as? ImageCollectionViewCell2 else{
            fatalError()
        }
...
class ImageCollectionViewCell2: UICollectionViewCell{
    static let identifier = "ImageCollectionViewCell2"
