//
//  ReservaEquipoTableViewController.swift
//  appReserva
//
...
class ReservaEquipoTableViewController: UITableViewController
{
    ...
    @IBAction func unwindToTableView(_ segue: UIStoryboardSegue){
        ...
        guard segue.identifier == "saveUnwind",
              let sourceViewController = segue.source as? AddEditReservaEquipoViewController,
...
//        UITextField.appearance().substituteFontName = Usuario.fondo
    ...
    @IBSegueAction func addEditReserva(_ coder: NSCoder, sender: Any?) -> UITableViewController? {
        if let cell = sender as? UITableViewCell, let indexPath = tableView.indexPath(for: cell){
            ...
            return AddEditReservaEquipoViewController(coder: coder, reservas: reservaToEdit)
        }
        else{
            //Agregando reserva
            return AddEditReservaEquipoViewController(coder: coder, reservas: nil)
        }
    }
